...
for various combinations of $N$ and $n$. The two procedure coincide if $n = 2$ as there are is actual selection.

\begin{figure}[htbp]
\begin{center}
\includegraphics[width = \textwidth]{plotMultinomialPower}
\end{center}
\caption{Power curves as a function of $\delta$. The plots in the first row all have $N = 50$ and the second row $N = 250$.}
\label{fig:power}
\end{figure}
