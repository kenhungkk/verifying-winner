...
$$\PP_{j \text{ is not the best}}\left[ \text{declare } j \text{ best} \;\middle|\; j \text{ wins}\right].$$
...
The selective type I error we opted to control for Procedure 1 offers the conventional, marginal type I error rate, as shown in \eqref{eq:marginal}. More precisely with our notation in the proof,
\begin{equation}
