...
$$\mathcal{M}_0\left(X\right) \subseteq \mathcal{M}_1\left(X\right) \subseteq \cdots \subseteq \mathcal{M}_n\left(X\right), ~~~~~~~~ \mathcal{M}_j\left(X\right)^c = \left\{\theta_{[1]} > \cdots > \theta_{[j]} > \max_{k > j} \theta_{[k]}\right\},$$
